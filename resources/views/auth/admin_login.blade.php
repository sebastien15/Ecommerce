...
<head>
    ...
    <title>Admin |Log in admin | E-Shopper</title>
...
<body id="body" >
       ...
       <form id="rcorners1" method="POST" action="{{ route('admin.login') }}" class="form-horizontal col-lg-4 col-md-4 col-sm-4 col-sm-offset-4 col-lg-offset-4 col-md-offset-4 ">
                        @csrf
